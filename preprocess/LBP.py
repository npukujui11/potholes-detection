...
# 输入和输出文件夹路径
input_folder = 'D:\\program\\potholes-detection\\dataset\\alldata_filled'  # 替换为您的输入图像文件夹路径
output_folder = 'D:\\program\\potholes-detection\\dataset\\alldata_filled_lbp'  # 替换为您希望保存LBP图像的文件夹路径
