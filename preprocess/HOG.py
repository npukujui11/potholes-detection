...
# 输入和输出文件夹路径
input_folder = 'D:\\program\\potholes-detection\\dataset\\sz640\\alldata_sz640_denoise'  # 输入图像文件夹路径
output_folder = 'D:\\program\\potholes-detection\\dataset\\sz640\\alldata_sz640_denoise_hog'  # 保存HOG图像的文件夹路径
