...
def load_data(data_dir, feature_dirs):
    ...
    for filename in os.listdir(data_dir):
        ...
        img = load_img(img_path, color_mode="grayscale", target_size=(240, 240))
        ...
        for feature_dir in feature_dirs:
            ...
            feature_img = load_img(feature_path, color_mode="grayscale", target_size=(240, 240))
...
data_dir = "D:\\program\\potholes-detection\\dataset\\sz240\\alldata_sz240"
feature_dirs = ["D:\\program\\potholes-detection\\dataset\\sz240\\alldata_sz240_filled_denoise_edge",
                "D:\\program\\potholes-detection\\dataset\\sz240\\alldata_sz240_filled_denoise_hog",
                "D:\\program\\potholes-detection\\dataset\\sz240\\alldata_sz240_filled_denoise_lbp"]
...
# 保存模型
model.save('inception_resnet_v2_fused_features_denoise_sz240.h5')
