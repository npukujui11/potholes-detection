...
def train_and_evaluate(X_train, y_train, X_test, y_test, classifier, classifier_name):
    ...
    precision = precision_score(y_test, y_pred, average='mirco')
    recall = recall_score(y_test, y_pred, average='mirco')
    f1 = f1_score(y_test, y_pred, average='mirco')
    jaccard = jaccard_score(y_test, y_pred, average='mirco')
