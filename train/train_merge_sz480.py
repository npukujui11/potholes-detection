...
def load_data(data_dir, feature_dirs):
    ...
    for filename in os.listdir(data_dir):
        ...
        img = load_img(img_path, color_mode="grayscale", target_size=(480, 480))
        ...
        for feature_dir in feature_dirs:
            ...
            feature_img = load_img(feature_path, color_mode="grayscale", target_size=(480, 480))
...
data_dir = "D:\\program\\potholes-detection\\dataset\\sz480\\alldata_sz480"
feature_dirs = ["D:\\program\\potholes-detection\\dataset\\sz480\\alldata_sz480_filled_denoise_edge",
                "D:\\program\\potholes-detection\\dataset\\sz480\\alldata_sz480_filled_denoise_hog",
                "D:\\program\\potholes-detection\\dataset\\sz480\\alldata_sz480_filled_denoise_lbp"]
...
# 保存模型
model.save('inception_resnet_v2_fused_features_denoise_sz480.h5')
