...
# 文件夹路径
input_folder = 'D:\\program\\potholes-detection\\dataset\\alldata_sz240'  # 图像文件夹路径
output_folder = 'D:\\program\\potholes-detection\\dataset\\alldata_sz240_edge'  # 输出边缘图的文件夹路径
